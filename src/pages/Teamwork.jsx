  ...
  return (
    <div className="py-14 fixed-padding relative overflow-hidden">
        ...
        {allCategories.map((category, index)=>{
            ...
            }} className={index === activeBtn ? "active py-2 px-4 border border-[#EF2B2D] rounded-xl cursor-pointer hover:bg-[#EF2B2D] hover:text-white duration-300" : 'py-2 px-4 border border-[#EF2B2D] rounded-xl cursor-pointer hover:bg-[#EF2B2D] hover:text-white duration-300'}>{category} </div>
        })}            
        </div>
